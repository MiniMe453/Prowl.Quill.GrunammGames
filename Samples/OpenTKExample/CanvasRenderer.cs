...
void main()
{
    ...
    gl_Position = projection * vec4(aPosition, 0.0, 1.0);
        ...
        public void RenderCalls(Canvas canvas, IReadOnlyList<DrawCall> drawCalls)
        {
            ...
            GL.BufferData(BufferTarget.ArrayBuffer, (int)canvas.VertextCount * Vertex.SizeInBytes, canvas.Vertices, BufferUsageHint.StreamDraw);
            ...
            GL.BufferData(BufferTarget.ElementArrayBuffer, (int)canvas.VertexIndexCount * sizeof(uint), canvas.Indices, BufferUsageHint.StreamDraw);
